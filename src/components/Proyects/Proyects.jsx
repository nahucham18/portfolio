        ...
        <div className={style.container}>
            ...
            <div className={style.proyects}>
                <div className={style.proyect}>
                    ...
                    <img className={style.imagen} src="#" alt="imgen del proyecto" />
                ...
                <div className={style.proyect}>
                    ...
                    <img className={style.imagen} src="#" alt="imgen del proyecto" />
                        <p>Es ejemplo de clonado de la pagina de "Harlem altas burgas", una pagina de pedidos de hamburguesas, mas adelante estare viendo en hacerle mejoras.</p>
                </div>
                <div className={style.proyect}>
                ...
                <div className={style.proyect}>
                    ...
                    <img className={style.imagen} src="#" alt="imgen del proyecto" />
                        <p>Lorem ipsum dolor, sit amet consectetur  adipisicing     elit. Perferendis quis temporibus    est .</p>
                </div>
            </div>
        </div>
    )
